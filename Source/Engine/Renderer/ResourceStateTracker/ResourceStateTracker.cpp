...
//		リソースの初期ステートを登録
// -------------------------------------------------------------------------------
void ResourceStateTracker::RegisterResource(ID3D12Resource* _pResource, D3D12_RESOURCE_STATES _initialState)
{
...
// -------------------------------------------------------------------------------
void ResourceStateTracker::TransitionResource(ID3D12Resource* _pResource, D3D12_RESOURCE_STATES _newState, UINT _subResource)
{
	if (_pResource == nullptr) 
	{ return; }
...
// -------------------------------------------------------------------------------
void ResourceStateTracker::FlushBarriers(ID3D12GraphicsCommandList* _pCmd)
{
	if (_pCmd == nullptr) 
	{ return; }
...
//		リソース破棄。追跡対象から外す
// -------------------------------------------------------------------------------
void ResourceStateTracker::UnRegisterResource(ID3D12Resource* _pResource)
{
	if (_pResource == nullptr) 
	{ return; }
